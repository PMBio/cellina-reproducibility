...
from spatialprop_train import clean_all_dirs
...
CRC_SLIDES = ['crc_120', 'crc_242', 'crc_231', 'crc_210', 'crc_221']
CRC_CELLTYPES = [
    "Endothelial",
    "Epithelial",
    "Fibroblast",
...
model_base_path = '.'
results_csv_name = f'../../results/ood_spatialprop_{DATASET_NAME}_DEG_{top_n}'
...
def main():
    ...
    for slide_id in SLIDES:
        ...
        for holdout_ct in CELLTYPES:
            ...
            mask_holdout = adata.obs[domains_key].str.contains(holdout_domains[0])
            ...
            for hd in holdout_domains:
                ...
                trained_model_path = f'{model_base_path}/output/{exp_name}/{slide_id}_Fibroblast_ood_expression_2hop_2augment_expression_none/weightedl1_1en03/model.pth'  
