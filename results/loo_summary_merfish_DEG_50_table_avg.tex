...
\toprule
Method & Spearman $\uparrow$ & Pearson $\uparrow$ & Signed Precision $\uparrow$ & RMSE\textsubscript{counts} $\downarrow$ & RMSE\textsubscript{LFC} $\downarrow$ \\
\midrule
...
\midrule
\rowcolor{gray!10}
cellina\textsubscript{node-pert} & \textbf{0.66 $\pm$ 0.21} & \textbf{0.80 $\pm$ 0.17} & \textbf{0.32 $\pm$ 0.17} & 3.63 $\pm$ 0.35 & 6.88 $\pm$ 4.61 \\
